...
DOCKER_MIRRORS=${3:-"https://6jjw0pnh.mirror.aliyuncs.com"}
KUBE_VERSION=1.7.5
...
echo "config --pod-infra-container-image=registry.cn-shenzhen.aliyuncs.com/bixin_k8s/pause-amd64:${KUBE_PAUSE_VERSION}"
cat > /etc/systemd/system/kubelet.service.d/20-pod-infra-image.conf <<EOF
[Service]
Environment="KUBELET_EXTRA_ARGS=--pod-infra-container-image=registry.cn-shenzhen.aliyuncs.com/bixin_k8s/pause-amd64:${KUBE_PAUSE_VERSION}"
EOF
...
echo '============================================================'
export KUBE_REPO_PREFIX="registry.cn-shenzhen.aliyuncs.com/bixin_k8s"

kubeadm join --token ${KUBE_TOKEN} ${MASTER_ADDRESS}:8443 --skip-preflight-checks
